...
import org.springframework.data.solr.server.config.CloudSolrClientBeanDefinitionParser;
...
class SolrNamespaceHandler extends NamespaceHandlerSupport {
	...
	public void init() {
		...
		registerBeanDefinitionParser("solr-cloud-client", new CloudSolrClientBeanDefinitionParser());
	}
}
